...
<div class="row">
  <div class="col-md-8" style="margin-bottom: 10px ;">
    <a href="javascript::void()" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modal-add-role">Add District</a>
  </div>
</div>
<div class="row">
  <div class="col-md-12">
        ...
        <table class="table table-striped data-table table-bordered table-hover display" id="example" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="javascript::void()" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modal-edit-role-{{$district->id}}">Edit</a>
                ...
                <form action="/roles/{{$district->id}}" method="post" style="display: inline-block;" id="delete-role-{{$district->id}}">
                  @csrf
                  @method('DELETE')
                </form>
